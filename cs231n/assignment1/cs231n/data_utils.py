...
def load_CIFAR10_pytorch(ROOT, train_batch_size = 50000, test_batch_size=1000):
  transform = transforms.Compose([
                                  transforms.ToTensor(),
                                ])

  train_dataset = torchvision.datasets.CIFAR10(ROOT, transform=transform, download=False)
  ...
  testloader =  DataLoader(test_dataset, batch_size=test_batch_size, shuffle=True, num_workers=4)
...
def get_CIFAR10_data_pytorch(num_training=49000, num_validation=1000, num_test=1000,
                     subtract_mean=True):
